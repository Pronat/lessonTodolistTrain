...
import { v1 } from 'uuid';
import {AddTodolistActionType, RemoveTodolistActionType, setTodolistsAC, SetTodolistsAT} from './todolists-reducer';
...
export const addTaskTC = (todoId: string, title: string) => (dispatch: Dispatch, getState: () => AppRootStateType) => {
